            ...
            <html>
                ...
                <div id="corps">
                    ...
                    <div>
                        ...
                        <p>Veuillez saisir l'ID du vendeur</p>
                        <form action="processus_suppression_vendeur.php" method="POST">
                        <label>ID :<input type="number" name="ID_Vendeur" maxlength="3" required /></label>
                        </form>
                    </div>
                </div>
